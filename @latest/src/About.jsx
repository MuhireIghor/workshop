        ...
        <section ref={aboutRef} id='aboutCont' className="about flex flex-row h-screen w-screen">
            ...
            <div className="texts flex flex-col w-1/2 space-y-4">
                ...
                <div className="but w-1/2 flex flex-col items-center justify-center">
                    <div className='flex flex-row w-full justify-around mr-6 mt-8 font-light text-xl'>
                        ...
                        <Link to='/signup'><button className='bg-blue-300 rounded-sm p-2 outline-none basis-1/2 ml-4 ' onClick={() => document.title = 'Sign Up Page'}>Get Started</button></Link>
                    </div>
                    {
                        act && (<div className={`more w-3/4 h-full mt-2 -ml-25  p-3 w-full shadow-md shadow-indigo-200`} >
